...
class TestDeserialize(TestCase):
    ...
    def test_pytree_namedtuple(self):
        ...
        self.assertTrue(
            ...
            in serialized.exported_program.graph_module.metadata
        )
        self.assertEqual(
            serialized.exported_program.graph_module.metadata[
                "treespec_namedtuple_fields"
            ],
            '{"test.export.test_serialize.test_pytree_namedtuple.N1": ["a", "b"], "test.export.test_serialize.test_pytree_namedtuple.N2": ["a", "b"]}',  # noqa: B950
        )
        ...
        self.assertEqual(
            len(deserialized.graph_module.meta["treespec_namedtuple_fields"]), 2
        )
